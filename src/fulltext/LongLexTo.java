...
public class LongLexTo {
  ...
  /*******************************************************************/
  public LongLexTo(String dictFile,Context context) throws IOException {

    dict=new Trie();
    addDict(dictFile,context);
  ...
  /**************************** addDict ******************************/
  /*******************************************************************/
  public void addDict(String dictFile,Context context) throws IOException {
   
    //Read words from dictionary
    String line, word, word2;
    int index;
    
    InputStream in = context.getAssets().open(dictFile);
  ...
  public static void main(String[] args) throws IOException {
    ...
    LongLexTo tokenizer=new LongLexTo(new File("//assets/lexitron.txt"));
    File unknownFile=new File("//assets/unknown.txt");
